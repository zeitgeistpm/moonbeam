...
//! # Migrations
use crate::{
	migrate_nominator_to_delegator_state, pallet::Total, BalanceOf, Bond, BottomDelegations,
	CandidateInfo, CandidateMetadata, CandidateState, CapacityStatus, CollatorCandidate,
	CollatorState2, Config, Delegations, DelegatorState, Event, ExitQueue2, NominatorState2,
	Pallet, Points, Round, RoundIndex, Staked, TopDelegations,
};
